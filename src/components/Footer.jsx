...
const Footer = () => {
  ...
  const getFooterInfo = (path) => {
    ...
    } else if (path.includes("remo")) {
      logo = "/assets/logoremo.png";
      title = "PB+ REMO";
      subtitle = "Your same life but better!";
      banner = "/assets/bannerremo.png";
      department = "Remo Department";
    } else {
  ...
  useEffect(() => {
    const { logo, title, subtitle, banner, department } =
      getFooterInfo(pathname);
    setFooterLogo(logo);
    ...
    <footer className=" divide-y xl:divide-y-0 bg-[#202225] text-gray-100">
        ...
        <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-start space-x-3">
              <a href="https://www.facebook.com/puntabandaplusens" title="Facebook" className="flex items-center p-1 gap-1">
                <svg
      ...
      <div className="bg-black flex justify-between py-4 px-2 xl:px-4">
        ...
        <div className="flex flex-col xl:flex-row">
          <img src="/assets/footerlogo.png" alt="" className="h-14 xl:h-32" />
