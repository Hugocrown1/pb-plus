        ...
        <section className="flex w-full relative">
          <div className="relative flex items-start justify-start h-[600px] bg-gray-200 w-full">
            <div className="flex flex-col gap-4 text-gray-900 text-left z-10 w-3/4 absolute top-0 left-0 ml-4 mt-4">
              <h1
                className={`text-white text-left text-[45px] leading-tight mx-8 my-24 w-1/2 ${roboto.className}`}
              >
                {service.mainTitle}
              </h1>
            </div>
            ...
            <div className="flex gap-8 absolute bottom-0 left-0 ml-4 mb-4">
              <Link href={"#contactus"}>
                <p className="px-16 py-3  font-semibold text-sm text-white transition-colors bg-[#cba557] hover:bg-[#534220]">
                  Contact Us
                </p>
              </Link>
              <Link href={"#learnmore"}>
                <p className="px-16 py-3 border border-[#cba557]  font-semibold text-sm text-white transition-colors hover:bg-[#cba557] hover:text-white">
                  Learn More
                </p>
              </Link>
            </div>
